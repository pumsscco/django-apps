...
class Aiconfig(models.Model):
    ai_type = models.ForeignKey('Aitype', on_delete=models.CASCADE, db_column='AI_TYPE', primary_key=True)  # Field name made lowercase.
...
class Aiproperty(models.Model):
    id = models.IntegerField(db_column='ID', primary_key=True)  # Field name made lowercase.
    ai_type = models.ForeignKey('Aitype', on_delete=models.CASCADE, db_column='AI_TYPE', blank=True, null=True)  # Field name made lowercase.
    team_state = models.ForeignKey('Teamstate', on_delete=models.CASCADE, db_column='TEAM_STATE', blank=True, null=True)  # Field name made lowercase.
    enemy_state = models.ForeignKey('Enemystate', on_delete=models.CASCADE, db_column='ENEMY_STATE', blank=True, null=True)  # Field name made lowercase.
...
class Equip(models.Model):
    id = models.IntegerField(db_column='ID', primary_key=True)  # Field name made lowercase.
    ea_type = models.ForeignKey('Equiptype', on_delete=models.CASCADE, db_column='TYPE', blank=True, null=True)  # Field name made lowercase.
...
class Good(models.Model):
    ...
    goods_type = models.ForeignKey('Goodstype', on_delete=models.CASCADE, db_column='GOODS_TYPE', blank=True, null=True)  # Field name made lowercase.
...
class Magic(models.Model):
    ...
    ai_cmd_type = models.ForeignKey(Aicommandtype, on_delete=models.CASCADE, db_column='AI_CMD_TYPE', blank=True, null=True)  # Field name made lowercase.
    target = models.ForeignKey('Skilltarget', on_delete=models.CASCADE, db_column='TARGET', blank=True, null=True)  # Field name made lowercase.
    felements = models.ForeignKey('Wuling', on_delete=models.CASCADE, db_column='FELEMENTS', blank=True, null=True)  # Field name made lowercase.
    ...
    acttype = models.ForeignKey(Acttype, on_delete=models.CASCADE, db_column='ACTTYPE', blank=True, null=True)  # Field name made lowercase.
...
class Monster(models.Model):
    ...
    race = models.ForeignKey('Race', on_delete=models.CASCADE, db_column='RACE', blank=True, null=True)  # Field name made lowercase.
    is_boss = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='IS_BOSS', blank=True, null=True)  # Field name made lowercase.
    ai_type = models.ForeignKey(Aitype, on_delete=models.CASCADE, db_column='AI_TYPE', blank=True, null=True)  # Field name made lowercase.
    ca_max_hp = models.IntegerField(db_column='CA_MAX_HP', blank=True, null=True)  # Field name made lowercase.
    ca_additional_rage = models.IntegerField(db_column='CA_ADDITIONAL_RAGE', blank=True, null=True)  # Field name made lowercase.
    ca_max_mp = models.IntegerField(db_column='CA_MAX_MP', blank=True, null=True)  # Field name made lowercase.
    ...
    physical_atk_targett = models.ForeignKey('Physicalattacktarget', on_delete=models.CASCADE, db_column='PHYSICAL_ATK_TARGETT', blank=True, null=True)  # Field name made lowercase.
    physical_atk_range = models.ForeignKey('Physicalattacktype', on_delete=models.CASCADE, db_column='PHYSICAL_ATK_RANGE', blank=True, null=True)  # Field name made lowercase.
...
class Prescription(models.Model):
    ...
    type = models.ForeignKey('Prescriptiontype', on_delete=models.CASCADE, db_column='TYPE', blank=True, null=True)  # Field name made lowercase.
    eet_sword = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='EET_SWORD', blank=True, null=True, related_name='Bool_eet_swords')  # Field name made lowercase.
    eet_dsword = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='EET_DSWORD', blank=True, null=True, related_name='Bool_eet_dswords')  # Field name made lowercase.
    eet_instrument = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='EET_INSTRUMENT', blank=True, null=True, related_name='Bool_eet_instruments')  # Field name made lowercase.
    eet_helmet = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='EET_HELMET', blank=True, null=True, related_name='Bool_eet_helmets')  # Field name made lowercase.
    eet_corselet = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='EET_CORSELET', blank=True, null=True, related_name='Bool_eet_corselets')  # Field name made lowercase.
    eet_legharness = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='EET_LEGHARNESS', blank=True, null=True, related_name='Bool_eet_legharnesss')  # Field name made lowercase.
    eet_ornament = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='EET_ORNAMENT', blank=True, null=True, related_name='Bool_eet_ornaments')  # Field name made lowercase.
...
class Property(models.Model):
    ...
    pa_type = models.ForeignKey('Propertyclass', on_delete=models.CASCADE, db_column='TYPE', blank=True, null=True)  # Field name made lowercase.
    prize_level = models.ForeignKey('Propertylevel', on_delete=models.CASCADE, db_column='PRIZE_LEVEL', blank=True, null=True)  # Field name made lowercase.
    target = models.ForeignKey('Skilltarget', on_delete=models.CASCADE, db_column='TARGET', blank=True, null=True)  # Field name made lowercase.
    ept_tianhe_can_use = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='ePT_TIANHE_CAN_USE', blank=True, null=True, related_name='Bool_ept_tianhe_can_use')  # Field name made lowercase.
    ept_linsha_can_use = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='ePT_LINSHA_CAN_USE', blank=True, null=True,                 related_name='Bool_ept_linsha_can_use')  # Field name made lowercase.
    ept_mengli_can_use = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='ePT_MENGLI_CAN_USE', blank=True, null=True,                 related_name='Bool_ept_mengli_can_use')  # Field name made lowercase.
    ept_ziying_can_use = models.ForeignKey(Bool, on_delete=models.CASCADE, db_column='ePT_ZIYING_CAN_USE', blank=True, null=True,                 related_name='Bool_ept_ziying_can_use')  # Field name made lowercase.
    ai_cmd_type = models.ForeignKey(Aicommandtype, on_delete=models.CASCADE, db_column='AI_CMD_TYPE', blank=True, null=True)  # Field name made lowercase.
...
class Role(models.Model):
    ...
    ca_additional_hitting = models.FloatField(db_column='CA_ADDITIONAL_HITTING', blank=True, null=True)  # Field name made lowercase.
    ca_pay_for_spare = models.FloatField(db_column='CA_PAY_FOR_SPARE', blank=True, null=True)  # Field name made lowercase.
    physical_atk_target = models.ForeignKey(Physicalattacktarget, on_delete=models.CASCADE, db_column='PHYSICAL_ATK_TARGET', blank=True, null=True)  # Field name made lowercase.
    physical_atk_range = models.ForeignKey(Physicalattacktype, on_delete=models.CASCADE, db_column='PHYSICAL_ATK_RANGE', blank=True, null=True)  # Field name made lowercase.
    sound_wounded1 = models.TextField(db_column='SOUND_WOUNDED1', blank=True, null=True)  # Field name made lowercase.
    sound_wounded2 = models.TextField(db_column='SOUND_WOUNDED2', blank=True, null=True)  # Field name made lowercase.
    sound_wounded3 = models.TextField(db_column='SOUND_WOUNDED3', blank=True, null=True)  # Field name made lowercase.
...
class Skill(models.Model):
    id = models.IntegerField(db_column='ID', primary_key=True)  # Field name made lowercase.
    type = models.ForeignKey('Skilltype', on_delete=models.CASCADE, db_column='TYPE', blank=True, null=True)  # Field name made lowercase.
    triger = models.ForeignKey('Skilltrigertype', on_delete=models.CASCADE, db_column='TRIGER', blank=True, null=True)  # Field name made lowercase.
