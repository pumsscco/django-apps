...
class PropertyGetView(View):
    ...
    template_name = 'pal4/pa_input.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            self.template_name='pal4/property_get_view.html'
...
class EquipGetView(View):
    ...
    template_name = 'pal4/ea_input.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            self.template_name='pal4/get_equip.html'
...
class SceneItemGetView(View):
    ...
    template_name = 'pal4/scene_input.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            self.template_name='pal4/sceneitems.html'
